...
tilde.crashspace.org is a great place to practice and learn more.
...
from GNU+Linux servers like tilde.crashspace.org through a web interface. But the
...
[tilde.crashspace.org](https://tilde.crashspace.org), and it ensures that nobody else along
the wire can listen in on your connection. Check out [our SSH
page](/wiki/ssh.html) for information on connecting to tilde.crashspace.org over
SSH.

If you are having trouble with making your first SSH connection to
tilde.crashspace.org, or anything else while you're learning from this tutorial,
vdrop by the [tilde.crashspace.org web chat](https://web.tilde.chat/) or email an
admin for help (<root@tilde.crashspace.org>).
...
self-directed learning. Once you're logged into tilde.crashspace.org (or any
...
client to log into tilde.crashspace.org. Once you're logged in, you can use the
...
tilde.crashspace.org.

Skipping some specifics for now, you can log into tilde.town from a
tilde.crashspace.org shell by using SSH as follows:

> `ssh username@tilde.crashspace.org`

Some shell servers allow you to log in with nothing more than a username
and password. But increasingly, many servers (like both tilde.crashspace.org and
tilde.town) require you to use ssh keys. To learn more about ssh keys,
again, see our [SSH page](ssh.md).
...
If you're still in your public_html directory, you should see a file
...
Now you can pull up a browser to see the change at your tilde.crashspace.org URL:
'https://tilde.crashspace.org/~yourUserName'

### Create a New File with `nano`

Let's create a new file in your public_html directory, called
'testing.html'.
...
'downloads' or 'public_html'), you can create a new files. Create a new
...
tutorial from tilde.crashspace.org user cmccabe's public_html directory:
...
GNU+Linux systems (like tilde.crashspace.org) adhere somewhat to an organization
...
https://tilde.crashspace.org/~username/testing.html
...
tilde.crashspace.org is about community, but it is about community of individuals
...
---
this tutorial is an edited copy of https://tilde.club/wiki/cli-for-beginners.html
