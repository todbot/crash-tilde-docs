...
a primary goal of tilde.crashspace.org is to be inclusive to the largest number of
...
**tilde.crashspace.org exists to foster an engaged community for socializing, learning,
...
to that end, tilde.crashspace.org strives to be a radically inclusive community where
...
a temporary ban or permanent expulsion from tilde.crashspace.org without warning
...
we expect all tilde.crashspace.org members to abide by this code of conduct while:

* engaging with other members 
* publishing content on tilde.crashspace.org
...
this code of conduct is based on the [tilde.club code of conduct](https://tilde.club/wiki/code-of-conduct.html)
which is based on
